...
#!perl
#line 15
    eval 'exec C:\Users\magja\graphviz-build-utilities\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'C:\Users\magja\graphviz-build-utilities\bin\perl.exe';
