...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAETOOMANYREFS WSAENETUNREACH WSAEPROTOTYPE WSAETIMEDOUT WSAEDISCON
	WSAENOTEMPTY WSAEINVAL WSAESHUTDOWN WSAELOOP WSAEDQUOT WSAEINTR
	WSAEPROTONOSUPPORT WSAEPROCLIM WSAEHOSTUNREACH WSAECANCELLED
	WSAEHOSTDOWN WSAEISCONN WSAEDESTADDRREQ WSAEUSERS WSAEMSGSIZE
	WSAESTALE WSAEADDRNOTAVAIL WSAENOTSOCK WSAEINVALIDPROCTABLE WSAENOBUFS
	WSAENOTCONN WSAEPROVIDERFAILEDINIT WSAEPFNOSUPPORT WSAECONNRESET
	WSAENOPROTOOPT WSAENETRESET WSAEALREADY WSAEAFNOSUPPORT WSAEREMOTE
	WSAEBADF WSAEADDRINUSE WSAEREFUSED WSAEWOULDBLOCK WSAENAMETOOLONG
	WSAEOPNOTSUPP WSAEACCES WSAEINVALIDPROVIDER WSAECONNREFUSED WSAEMFILE
	WSAESOCKTNOSUPPORT WSAENOMORE WSAENETDOWN WSAEINPROGRESS
	WSAECONNABORTED WSAEFAULT
    )],
);
